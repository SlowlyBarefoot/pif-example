...
void appSetup()
{
    ...
    if (!pifTask_Add(TM_enPeriodMs, 10, pifSensorSwitch_Task, pstPushSwitch, TRUE)) return;	// 10m
    ...
    if (!pifTask_Add(TM_enPeriodMs, 1, pifComm_Task, s_pstCommGps, TRUE)) return;			// 1ms
