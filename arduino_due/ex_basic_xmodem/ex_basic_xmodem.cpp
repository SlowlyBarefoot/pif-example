...
void setup()
{
    ...
    if (!pifUart_AttachTxTask(&g_uart, PIF_ID_AUTO, TM_EXTERNAL, 0, "UartTxLog")) return;
    if (!pifUart_AttachRxTask(&g_uart, PIF_ID_AUTO, TM_PERIOD, 200000, "UartRxLog")) return;	// 200ms
