...
void setup()
{
    ...
    if (!pifTaskManager_Init(TASK_SIZE, 2)) return;
    ...
    if (!pifStepMotorSpeed_Init(&g_motor, PIF_ID_AUTO, &g_timer_200us, STEP_MOTOR_RESOLUTION,
	...
	pifLog_Print(LT_NONE, "***         exStepMotorSpeed         ***\n");
