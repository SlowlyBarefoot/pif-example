...
void setup()
{
    ...
    if (!pifUart_AttachTxTask(&s_uart_log, TM_EXTERNAL_ORDER, 0, "UartLog")) { line = __LINE__; goto fail; }
    if (!pifUart_AttachRxTask(&s_uart_log, TM_PERIOD, 200000, "UartLog")) { line = __LINE__; goto fail; }			// 200ms
