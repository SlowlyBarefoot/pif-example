...
#define UART_SPEKTRUM_BAUDRATE	115200
...
void setup()
{
    ...
    if (!pifUart_AttachTxTask(&g_uart_spektrum, PIF_ID_AUTO, TM_EXTERNAL, 0, "UartSpektrum")) return;
	...
	pifLog_Print(LT_NONE, "***         ex_ibus2spektrum         ***\n");
