...
int main(void)
{
  ...
  pif_Init(micros);
    ...
    if (!pifUart_AttachTxTask(&g_uart_device, TM_EXTERNAL_ORDER, 0, "UartTxHost")) { line = __LINE__; goto fail; }
    if (!pifUart_AttachRxTask(&g_uart_device, TM_PERIOD, 1000, "UartRxHost")) { line = __LINE__; goto fail; }		// 1ms
